...
- **PIE disabled**: See [AD3001: EnablePositionIndependentExecutable](AD3001.EnablePositionIndependentExecutable.md)
- **RELRO not Full**: See [AD3010: EnableReadOnlyRelocations](AD3010.EnableReadOnlyRelocations.md)
- **Stack Protector missing**: See [AD3003: EnableStackProtector](AD3003.EnableStackProtector.md)
- **FORTIFY_SOURCE not used**: See [AD3030: UseGccCheckedFunctions](AD3030.UseGccCheckedFunctions.md)
